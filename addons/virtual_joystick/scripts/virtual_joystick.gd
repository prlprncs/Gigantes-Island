...
func _draw() -> void:	
	...
	joystick.texture = border if is_instance_valid(border) else preload("res://addons/virtual_joystick/sprites/border.webp")
	touch.texture_normal = stick if is_instance_valid(stick) else preload("res://addons/virtual_joystick/sprites/stick.webp")
